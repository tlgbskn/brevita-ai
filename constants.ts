...
- Must be stable for pdf conversion.
- Text content MUST match the requested OUTPUT_LANGUAGE.
...
- If OUTPUT_LANGUAGE is "TR" (Turkish):
  - The entire content of the report (summary, key points, context, bias, military brief, AND pdf_html) MUST be written in TURKISH.
  - In "pdf_html", all visible text including headers, labels, and badges MUST be in TURKISH (e.g., "Executive Summary" -> "Yönetici Özeti").
