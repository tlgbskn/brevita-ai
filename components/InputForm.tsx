        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-4 py-2.5 bg-white dark:bg-slate-900 border rounded-lg focus:ring-2 focus:ring-indigo-500 text-sm text-slate-800 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 ${
                 !formData.article && !formData.url ? 'border-red-300 dark:border-red-800' : 'border-slate-200 dark:border-slate-700'
              }`}
              value={formData.url}
            ...
            <div className="flex bg-white dark:bg-slate-900 rounded-lg p-1 border border-indigo-100 dark:border-indigo-900/50 shadow-sm inline-flex w-full">
              <button
                ...
                className={`flex-1 px-2 py-1.5 text-xs font-medium rounded-md transition-colors ${
                  formData.mode === AnalysisMode.STANDARD 
              ...
              <button
                ...
                className={`flex-1 px-2 py-1.5 text-xs font-medium rounded-md transition-colors flex items-center justify-center gap-1 ${
                  formData.mode === AnalysisMode.MILITARY
