...
const AnalysisView: React.FC<AnalysisViewProps> = ({ data }) => {
  ...
  const generateShareableText = () => {
    ...
    return `BREVITA INTEL BRIEF\n\n` +
           `📄 ${meta.title}\n` +
           `📅 ${meta.date || 'N/A'} | ⏱️ ${meta.estimated_reading_time_seconds}s Read\n\n` +
           `SUMMARY:\n${summary_30s}\n\n` +
    ...
    <div className="animate-fade-in space-y-8 pb-12">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap items-center gap-4 mt-3 text-sm text-slate-500 dark:text-slate-400 font-medium uppercase tracking-wider">
              ...
              <div className="flex items-center gap-1 text-indigo-600 dark:text-indigo-400">
                <Clock size={16} />
                <span>{data.meta.estimated_reading_time_seconds}s READ</span>
              </div>
              {isMilitary && (
                <span className="flex items-center gap-1 bg-amber-100 dark:bg-amber-900/40 text-amber-800 dark:text-amber-300 px-2 py-1 rounded border border-amber-200 dark:border-amber-800/50">
                  <ShieldAlert size={14} /> MILITARY MODE
                </span>
              )}
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {data.groundingChunks && data.groundingChunks.length > 0 && (
             <section className="bg-slate-50 dark:bg-slate-800/50 p-5 rounded-xl border border-slate-200 dark:border-slate-700">
               <h3 className="text-sm font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-3 flex items-center gap-2">
                  <Globe size={16} /> Verified Sources
               </h3>
        ...
        <div className="space-y-6">
          {isMilitary ? (
            <MilitaryPanel data={data.military_mode} />
          ) : (
             <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
                <h3 className="text-sm font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-4">Standard Analysis</h3>
                <p className="text-slate-500 dark:text-slate-400 text-sm">
                  Enable Military Mode for OSINT-grade analysis, including actor profiles, threat assessments, and strategic implications.
                </p>
             </div>
          )}
        </div>
...
const MilitaryPanel: React.FC<{ data: BrevitaResponse['military_mode'] }> = ({ data }) => {
      ...
      <div className="p-5 space-y-6 text-sm">
        ...
        <div className="space-y-3">
           <div className="flex items-center justify-between">
              <span className="text-slate-400 text-xs uppercase font-mono">Threat Level</span>
        ...
        {/* Actors */}
        <div>
          <h4 className="text-slate-400 font-mono text-xs uppercase mb-2">Key Actors</h4>
        ...
        {/* Objectives */}
        <div>
          <h4 className="text-slate-400 font-mono text-xs uppercase mb-2">Objectives & Interests</h4>
         ...
         {/* Risks */}
        <div>
          <h4 className="text-slate-400 font-mono text-xs uppercase mb-2">Risks & Threats</h4>
        ...
        {/* Implications */}
        <div>
           <h4 className="text-slate-400 font-mono text-xs uppercase mb-2">Operational Implications</h4>
        ...
        <div className="bg-slate-800/50 p-3 rounded border border-slate-700/50">
           <h4 className="text-amber-500 font-mono text-xs uppercase mb-2 flex items-center gap-2">
             <Eye size={14} /> Commander Watchpoints
           </h4>
